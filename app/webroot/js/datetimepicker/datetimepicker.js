...
(function($) {
    var lang = {
        ...
        ro:{
            days: ['Dum', 'Lun', 'Mar', 'Mie', 'Joi', 'Vin', 'SĂ¢m'],
        ...
        ru: {
            days: ['Đ’Ñ', 'ĐŸĐ½', 'Đ’Ñ‚', 'Đ¡Ñ€', 'Đ§Ñ‚', 'ĐŸÑ‚', 'Đ¡Đ±'],
            months: [ "Đ¯Đ½Đ²", "Đ¤ĐµĐ²", "ĐœĐ°Ñ€", "ĐĐ¿Ñ€", "ĐœĐ°Đ¹", "Đ˜ÑĐ½", "Đ˜ÑĐ»", "ĐĐ²Đ³", "Đ¡ĐµĐ½", "ĐĐºÑ‚", "ĐĐ¾Ñ", "Đ”ĐµĐº" ],
            format: 'DD.MM.YYYY hh:mm'
        },
        br: {
            days: ['Dom', 'Seg', 'Ter', 'Qua', 'Qui', 'Sex', 'SĂ¡b'],
        ...
        de: {
            ...
            months: [ "Jan", "Feb", "MĂ¤rz", "Apr", "Mai", "Juni", "Juli", "Aug", "Sept", "Okt", "Nov", "Dez" ],
            format: 'DD.MM.YYYY hh:mm'
        },
        sv: {
            days: ['SĂ¶', 'MĂ¥', 'Ti', 'On', 'To', 'Fr', 'LĂ¶'],
        ...
        tr: {
            days: ['Pz', 'Pzt', 'Sal', 'Ă‡ar', 'Per', 'Cu', 'Cts'],
            months: [ "Ock", "Åub", "Mar", "Nis", "May", "Haz", "Tem", "Agu", "Eyl", "Ekm", "Kas", "Arlk" ]
        },
        es: {
            days: ['dom', 'lun', 'mar', 'miĂ©r', 'jue', 'viĂ©', 'sĂ¡b'],
            months: [ "ene", "feb", "mar", "abr", "may", "jun", "jul", "ago", "sep", "oct", "nov", "dic" ],
            format: 'DD/MM/YYYY hh:mm'
        },
        ko: {
            days: ['́¼', '́›”', 'í™”', '́ˆ˜', 'ëª©', 'ê¸ˆ', 'í† '],
        ...
        cz: {
            days: ['Ne', 'Po', 'Ăt', 'St', 'ÄŒt', 'PĂ¡', 'So'],
            months: [ "Led", "Ăno", "BÅ™e", "Dub", "KvÄ›", "ÄŒer", "ÄŒvc", "Srp", "ZĂ¡Å™", "Å˜Ă­j", "Lis", "Pro" ],
            format: 'DD.MM.YYYY hh:mm'
        },
        fr: {
